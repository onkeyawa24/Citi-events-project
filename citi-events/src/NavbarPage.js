...
import {
  FaUserCircle, FaBell, FaHome, FaCalendarAlt, FaBullhorn, FaCheckCircle, FaSearch
} from 'react-icons/fa';
    ...
    <Navbar fixed="top" expand="lg" style={{ backgroundColor: '#0D1B2A' }} variant="dark" className="shadow-sm py-2">
      <Container fluid className="px-3 d-flex align-items-center justify-content-between">
        ...
        <Navbar.Collapse id="main-navbar" className="justify-content-center">
          <Nav className="d-flex flex-column flex-lg-row align-items-center gap-4 text-center">
        ...
        {/* Right Icons */}
        <Nav className="d-flex flex-row align-items-center gap-3 text-white">
